...
commit;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--1)Monte um relatório com os nomes dos instrutores e alunos cadastrados no banco de 
--dados. Garanta que os nomes repetidos sejam eliminados.

select inst_nome as "Alunos e Instrutores" from instrutor
union
select alu_nome from aluno

--2)Refaça o mesmo relatório, porém, agora, não eliminando os nomes repetidos.
