--Versão do banco de dados: 20230201
...
insert into obra values (1,'001','Prédio');
insert into obra values (2,'002','Casa');
insert into obra values (3,'003','Casa1');
insert into obra values (4,'004','Casa2');
...
insert into maquina values (1,'MA001','Hitachi');
insert into maquina values (2,'MA002','CargoBob');
insert into maquina values (3,'MA003','Britax');
 --drop table usa
create table usa (
        id_usa serial,
        id_obra int,
...
insert into usa values (1,1,1,'01/03/2023');
insert into usa values (2,2,2,'02/04/2025');		
insert into usa values (3,2,3,'03/04/2026');
insert into usa values (4,2,3,'05/06/2027');
insert into usa values (5,4,3,'06/12/2027');
insert into usa values (6,2,1,'12/12/2027');
--1A)
SELECT ob.descricao , ma.marca , us.data_uso
FROM obra ob
INNER JOIN usa us
ON ob.id_obra = us.id_obra
INNER JOIN maquina ma
ON us.id_maquina = ma.id_maquina
ORDER BY ob.descricao;
--1B)
SELECT ob.descricao, COUNT(DISTINCT us.id_maquina) 
FROM obra ob
INNER JOIN usa us 
ON ob.id_obra = us.id_obra
GROUP BY ob.descricao;
--2)
